...
echo "------->>> TF_VAR_tenancy_id= ${TF_VAR_user_id}"
echo "------->>> TF_VAR_tenancy_id= ${TF_VAR_fingerprint}"
echo "------->>> TF_VAR_tenancy_id= ${TF_VAR_private_key}"
echo "------->>> TF_VAR_tenancy_id= ${TF_VAR_ssh_authorized_keys}"
...
echo "------->>> TF_VAR_ssh_private_key= ${TF_VAR_ssh_private_key}"
ENV="$(env)"
echo "------->>> TF_VAR_ssh_private_key= ${ENV}"
